...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cropduster_size', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('size_set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cropduster.SizeSet'], null=True)),
            ...
            ('auto_crop', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('retina', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        ...
        db.create_table('cropduster_image_meta', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('attribution', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('attribution_link', self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True)),
            ('caption', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('cropduster', ['ImageMetadata'])

        # Adding model 'Image'
        db.create_table('cropduster_image', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('original', self.gf('django.db.models.fields.related.ForeignKey')(related_name='derived', null=True, to=orm['cropduster.Image'])),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['filer.Image'], null=True, blank=True)),
            ('size', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cropduster.Size'], null=True)),
            ('crop', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cropduster.Crop'], unique=True, null=True)),
            ('metadata', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cropduster.ImageMetadata'], null=True, blank=True)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
        ...
        # Adding M2M table for field size_sets on 'Image'
        db.create_table('cropduster_image_size_sets', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('image', models.ForeignKey(orm['cropduster.image'], null=False)),
            ('sizeset', models.ForeignKey(orm['cropduster.sizeset'], null=False))
        ))
        db.create_unique('cropduster_image_size_sets', ['image_id', 'sizeset_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('cropduster_image_meta')

        # Deleting model 'Image'
        db.delete_table('cropduster_image')

        # Removing M2M table for field size_sets on 'Image'
        db.delete_table('cropduster_image_size_sets')
    ...
    models = {
        ...
        'cropduster.image': {
            ...
            'crop': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cropduster.Crop']", 'unique': 'True', 'null': 'True'}),
            ...
            'metadata': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cropduster.ImageMetadata']", 'null': 'True', 'blank': 'True'}),
            'original': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'derived'", 'null': 'True', 'to': "orm['cropduster.Image']"}),
            'size': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cropduster.Size']", 'null': 'True'}),
            'size_sets': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['cropduster.SizeSet']", 'null': 'True', 'symmetrical': 'False'}),
            'width': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'})
        },
        'cropduster.imagemetadata': {
            'Meta': {'object_name': 'ImageMetadata', 'db_table': "'cropduster_image_meta'"},
        ...
        'cropduster.size': {
            ...
            'auto_crop': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'height': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'}),
            'retina': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'size_set': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cropduster.SizeSet']", 'null': 'True'}),
